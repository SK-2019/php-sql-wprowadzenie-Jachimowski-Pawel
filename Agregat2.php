...
worker(1,"SELECT SUM(zarobki) as suma_zarobki,nazwa_dzial FROM pracownicyn organizacja WHERE id_org=dzial GROUP BY dzial HAVING SUM(zarobki)<28 ","Suma zarobków w poszczególnych działach mniejsza od 28 ","suma_zarobki","nazwa_dzial");
?>
