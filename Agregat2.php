...
worker(1,"SELECT sum(zarobki)as suma_zarobki,nazwa_dzial from pracownicy,organizacja where id_org=dzial Group by dzial Having SUM(zarobki)<28","Suma zarobków w poszczególnych działach mniejsza od 28 ","suma_zarobki","nazwa_dzial");
?>
